...
cmd_hugo_server =
  "#{cmd_mutagen_check} || (" \
  "#{cmd_hugo_server_mutagen_start} && " \
  "trap \"#{cmd_hugo_server_mutagen_stop}\" INT; " \
  'hugo server ' \
